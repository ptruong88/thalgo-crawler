...
from utils.selenium_element import get_element_text, get_element_attribute, get_elements, get_url
...
class ActionPage:
    ...
    def get_item_page_links(self):
        ...
        try:
            ...
            # product_item_elements = self.page_content_driver.get_element_by_class_name('avb').get
